...
class pulsesensor:
    ...
    def getBPMLoop(self:
        ...
        T = 512             #used to fine trough in pulse wave, seeded
        ...
        while not self.thread.stopped:
            ...
            if N > 250:                                 #avoid high frequency noise
                if Signal > thresh and Pulse == False and N > (IBI/5.0)*3:
                    ...
                    lastBeatTime = sampleCounter        #keep tract of time for next pulse
            ...
            if N > 2500:                                #if 2.5 seconds go by without a beat
                ...
                firstBeat = True                        #set time these to avoid noise
    ...
    #start getBPMLoop routine which saves the BPM in its variables
